<template>
	<div class="login">
		    ...
		    <div class="login-cnt-form" >
		        ...
		        <div class="ctr relative">
		            ...
		            <div class="_pwr ">
		                ...
		                <p class="_tip"><span class="iconfont iconwarning"></span>xxxx 不会以任何理由要求您转账汇款，谨防诈骗。</p>
		
		                <div class="_item v-tab">
		
		                    <!-- tab 标题-->
		                    <ul class="_item-tab-ttl v-tab-btns">
		                        <li class="v-tab-btn" v-bind:class="{'active':tabIndex==0}" @click="tabIndex=0" > 账号登录</li>
		                        <li  class="v-tab-btn" v-bind:class="{'active':tabIndex==1}" @click="tabIndex=1"> 验证码登录</li>
		                    </ul>
		                    ...
		                    <div class="_item-tab-cnt v-tab-cnt" >
		                        ...
		                        <!--账户登录-->
		                        <div class="_item-tab-cnt-item v-tab-cnt-item "
								 v-bind:class="{'in':tabIndex==0}" id="accountLogin">
		...
		<!--   <ul class="login-ft-nav  ctr">
		        ...
		        <li>
		            <a href="../info/hyzx.html" title="行业资讯">行业资讯</a>
		        </li>
		
		        <li>
		            <a href="../info/hyzl.html" title="行业资料">行业资料</a>
		        </li>
		
		        <li>
		            <a href="../pricemap" title="价格走势">价格走势</a>
		        </li>
		
		        <li>
		            <a href="../matter" title="物性表">物性表</a>
		        </li>
		
		        <li>
		            <a href="../help/" title="关于我们">关于我们</a>
		        </li>
